...
Najprościej rzecz ujmując, kwantyzacja polega na przypisaniu liczb z przestrzeni rzeczywistej do skończonego zbioru wartości reprezentowalnych w wybranym formacie. Jeżeli oznaczyć oryginalną wartość przez $x$, to proces kwantyzacji można opisać funkcją
\begin{equation}
	q = Q(x),
\end{equation}
