...
Prawdziwym przełomem inżynierii wstecznej w metodzie GGUF jest \textbf{\textit{Importance Matrix}} i podtypy \textbf{IQ} (\textit{Importance Quantization}). W tej metodzie nie określamy istotności prosto z~wariancji aktywacji lecz statystycznie z~kalibracyjnego zbioru treningowego wyliczamy entropię punktową. Otrzymujemy tensor ważności dla wag, bazując na ważonym błędzie kwantyzacji.
